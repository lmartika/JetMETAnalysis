...
ak8PFL1FastL2L3 = ak8PFJetsL2L3.clone()
...
ak8PFCHSL1FastL2L3 = ak8PFJetsL2L3.clone()
...
#ak1PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK1PFPuppi' )
#ak2PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK2PFPuppi' )
#ak3PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK3PFPuppi' )
#ak4PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK4PFPuppi' )
#ak5PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK5PFPuppi' )
#ak6PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK6PFPuppi' )
#ak7PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK7PFPuppi' )
#ak8PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK8PFPuppi' )
#ak9PUPPIL2Relative  = ak4PFJetsL2Relative.clone( algorithm = 'AK9PFPuppi' )
#ak10PUPPIL2Relative = ak4PFJetsL2Relative.clone( algorithm = 'AK10PFPuppi' )
